...
router.get("/", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), listVehicles)
router.get("/compliance-report", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), fleetComplianceReport)
router.get("/:id", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), getVehicle)
...
router.get("/:id/maintenance", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), listMaintenanceRecords)
