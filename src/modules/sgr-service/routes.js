...
const SGR_STAFF = ["SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER"]
...
// First mile
router.post("/:id/first-mile", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), startFirstMile)

// Station operations
router.post("/:id/receive-cargo", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER"), receiveCargo)
router.post("/:id/screening/start", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER"), beginScreening)
router.post("/:id/screening/complete", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER"), finishScreening)

// Train assignment + loading
router.post("/:id/assign-train", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER"), allocateToTrain)
router.post("/:id/load-cargo", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER"), loadCargo)

// Train departure / arrival (by train capacity ID)
router.post("/trains/:trainCapacityId/depart", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), departTrainController)
router.post("/trains/:trainCapacityId/arrive", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER"), arriveTrainController)

// Last mile
router.post("/:id/last-mile", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), startLastMile)

// Collection (station-to-station)
router.post("/:id/collect", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER"), collectCargo)
...
router.post("/:id/verify-weigh", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER"), verifyAndWeigh)
router.post("/consolidate", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), consolidateShipments)
router.post("/load-on-train", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), loadOnTrain)
router.post("/manifests/:id/arrive", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), arriveAtDestination)
