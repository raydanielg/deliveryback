...
const EXCEPTIONS_STAFF = ["SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER", "DRIVER"]
...
router.post("/", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER", "DRIVER"), createException)
router.post("/return", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER", "DRIVER"), createReturn)
router.post("/report", authorizeRoles("DRIVER", "SUPER_ADMIN", "OPERATIONS_MANAGER"), createDriverReport)
