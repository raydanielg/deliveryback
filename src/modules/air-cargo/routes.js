...
const AIR_CARGO_STAFF = ["SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER"]
...
router.post("/:id/accept", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER", "WAREHOUSE_MANAGER"), acceptCargo)
router.post("/flight-dispatch", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), createFlightDispatch)
router.post("/manifests/:id/arrive", authorizeRoles("SUPER_ADMIN", "OPERATIONS_MANAGER"), arriveAtAirport)
